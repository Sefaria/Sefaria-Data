...
index = post_index({'title': 'Mekhilta DeRabbi Yishmael'}, method='GET', server='https://beeri.cauldron.sefaria.org')
...
post_index(index,  server='https://beeri.cauldron.sefaria.org')
