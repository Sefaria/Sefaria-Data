...
parshiot = ["Devarim", "Vaetchanan", "Eikev", "Re'eh", "Shoftim", "Ki Teitzei", "Ki Tavo", "Nitzavim", "Vayeilech", "Ha'Azinu",
"V'Zot HaBerachah"]
...
prev_parsha = ""
last_log = ""
if os.path.exists("perek_Devarim.txt") == True:
	os.remove("perek_Devarim.txt")	
perek_file = open('perek_Devarim.txt', 'w')
if os.path.exists("parsha_Devarim.txt") == True:
	os.remove("parsha_Devarim.txt")
parsha_file = open("parsha_Devarim.txt", 'w')
