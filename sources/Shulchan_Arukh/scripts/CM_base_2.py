...
def markup(b_vol):
    ...
    b_vol.mark_references(commentaries.commentary_ids["Ketzot HaChoshen"], u'/([\u05d0-\u05ea]{1,3})\)', group=1)
    ...
    b_vol.mark_references(commentaries.commentary_ids["Siftei Kohen"], u'@77\(([\u05d0-\u05ea]{1,3})\)', group=1)
