...
filename = u"../../txt_files/Choshen_Mishpat/part_3/נתיבות המשפט חושן משפט חלק ג ביאורים מוכן.txt"
...
errors = b_vol.validate_all_xrefs_matched(lambda x: x.name=='xref' and re.search(u'@53', x.text) is not None)
for i in errors:
    print i
root.export()
