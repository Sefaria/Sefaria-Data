...
title_comm = "Tosefot Yom Tov, Meilah"
title_book = "Mishnah Meilah"
...
for each_perek in range(len(dh_comm_dict)):
	for each_mishnah in range(len(dh_comm_dict[each_perek+1])):
		text = {
		...
		"language": "he",
		"text": dh_comm_dict[each_perek+1][each_mishnah+1],
		}
		post_text(title_comm+"."+str(each_perek+1)+"."+str(each_mishnah+1), text)
		for each_comment in range(len(dh_comm_dict[each_perek+1][each_mishnah+1])):
			createLinks(each_perek+1, each_mishnah+1, each_comment)