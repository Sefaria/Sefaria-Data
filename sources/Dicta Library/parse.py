...
from sources.functions import post_index, post_text, post_link_in_steps
...
def create_simple_index(en_title, he_title, categories, section_names, address_types=None):
...
class DictaLibraryManager:
    ...
    def create_and_post_parallels_commentary(self, server, post=False):
        index = create_simple_index("Dicta Parallels", "המקבילות של דיקטה", ["Reference"], ["Chapter", "Paragraph"], ["Integer", "Integer"])
        links = []
        parallels_text = []
