...
def create_simple_index(en_title, he_title, categories, section_names, address_types=None, collective=None):
    ...
    root.validate()
    if collective:
        add_term(collective['en'], collective['he'])
    index = {
        "title": en_title,
...
class DictaLibraryManager:
    ...
    def create_and_post_parallels_commentary(self, book: 'DictaBook', server, post=False):
        index = create_simple_index(DICTA_PARALLELS_INDEX_NAME + " on " + book.displayNameEnglish,
                                    DICTA_PARALLELS_INDEX_NAME_HE + " על " + book.displayName, ["Reference", "Dicta Parallels"],
...
if __name__ == '__main__':
    ...
    dicta.create_and_post_parallels_commentary(book, args.server, post=True)
