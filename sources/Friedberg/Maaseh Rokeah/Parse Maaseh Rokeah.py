...
def clean_segments(segments):
    def clean_segment(seg):
        ...
        seg = seg.replace(u"@05", u"<b>").replace(u"@06", u"</b>").replace(u"@01", u"<b>").replace(u"@02",
                                                                                                   u"</b>").replace(
            u"@03", u"<br/>").strip()
        return seg
...
# Make categories
http_request(SEFARIA_SERVER + "/api/category", body={'apikey': API_KEY}, json_payload={"path":["Halakhah","Mishneh Torah","Commentary","Maaseh Rokeah"], "sharedTitle": "Maaseh Rokeah"}, method="POST")
