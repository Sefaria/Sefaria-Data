...
if __name__ == "__main__":
    #### text and links are correct, now just cascade source sheet changes
    from sefaria.helper.schema import *
    previous_sheet_refs = []
    new_sheet_refs = []

    def needs_rewrite(str, **kwargs):
        return str in previous_sheet_refs

    def rewriter(str):
        assert str in previous_sheet_refs
        pos = previous_sheet_refs.index(str)
        return new_sheet_refs[pos]
