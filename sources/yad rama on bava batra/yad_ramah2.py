...
root = SchemaNode()
root.key = 'yadramah'
root.add_title("Yad Ramah on Bava Batra", "en", primary=True)
root.add_title(u"יד רמה על בבא בתרא", "he", primary=True)
            ...
            for comment_key in comments_order[current_perek]:
                ...
                post_link({
                    "refs": [
                            ...
                            "Yad Ramah on Bava Batra, Perek "+str(current_perek)+", Comment "+str(comment_key)
                        ],
                    "type": "commentary",
                    "auto": True,
