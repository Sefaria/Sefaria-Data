...
def create_alt_struct_refs():
    return {
        ...
        "Noach" : {'intro': 'Rabbeinu_Bahya,_Bereshit.6.9.1-2', 'comments': 'Rabbeinu_Bahya,_Bereshit.6.9.3-11.32.5'},
        "Lech Lecha" : {'intro': 'Rabbeinu_Bahya,_Bereshit.12.1.1-2', 'comments': 'Rabbeinu_Bahya,_Bereshit.12.2.1-17.24.3'},
        "Vayera" : {'intro': 'Rabbeinu_Bahya,_Bereshit.18.1.1-2', 'comments': 'Rabbeinu_Bahya,_Bereshit.18.1.3-22.20.1'},
        "Chayei Sara" : {'intro': 'Rabbeinu_Bahya,_Bereshit.23.1.1-6', 'comments': 'Rabbeinu_Bahya,_Bereshit.23.1.7-25.9.2'},
        "Toldot" : {'intro': 'Rabbeinu_Bahya,_Bereshit.25.19.1-3', 'comments': 'Rabbeinu_Bahya,_Bereshit.25.19.4-28.6.4'},
        "Vayetzei" : {'intro': 'Rabbeinu_Bahya,_Bereshit.28.10.1-4', 'comments': 'Rabbeinu_Bahya,_Bereshit.28.10.5-32.3.2'},
        "Vayishlach" : {'intro': 'Rabbeinu_Bahya,_Bereshit.32.4.1-10', 'comments': 'Rabbeinu_Bahya,_Bereshit.32.4.11-36.39.5'},
        ...
        "Mishpatim" : {'intro': 'Rabbeinu_Bahya,_Shemot.21.1.1-3', 'comments': 'Rabbeinu_Bahya,_Shemot.21.1.4-24.17.1'},
