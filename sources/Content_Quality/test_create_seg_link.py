...
print(Ref("Rashi on Shabbat 2a:1-3a:7"))
print(Ref("Rashi on Shabbat 2a:1-3b:2"))
print(Ref("שבת לג").normal())
print(Ref("שבת לג, א–ב").normal())
print(Ref("שבת לג, א–ב").he_normal())
...
Ref("Shabbat 24b.12-24")

print(Ref("Yoma 87").normal())
print(Ref("Yoma 87-90").normal())
print(Ref("Yoma 88").normal())
