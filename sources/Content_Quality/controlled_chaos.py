...
if __name__ == "__main__":
    ...
    print(f"Finding {len(current_II_Samuel_links)} on {server} and expecting {(len(orig_II_Samuel_links) + len(additional_II_Samuel_links))}")
    ...
    for i, l in tqdm(enumerate(orig_II_Samuel_links)):
        orig_II_Samuel_links[i] = {"refs": l["refs"], "auto": True, "generated_by": "chaos script", "type": "Commentary"}
