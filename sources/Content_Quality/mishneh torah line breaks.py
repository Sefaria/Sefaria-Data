...
soup = selenium_get_url("/Users/stevenkaplan/Documents/chromedriver", "https://steinsaltz-center.org/he/portal/library/Humash/Genesis/chapter/1")
with open('steinsaltz.html', 'w') as f:
    f.write(soup)
