...
for count in range(10):
	...
	part1_prin1_content.depth = 2
	part1_prin1_content.lengths = [lengths[count]]
	part1_prin1_content.sectionNames = ["Article", "Paragraph"]
	part1_prin1_content.heSectionNames = [u"סעיף", u"פרק"]
	part1_prin1_content.addressTypes = ["Integer", "Integer"]
...
for count in range(9):
	...
	part2_prin1_content.depth = 2
	part2_prin1_content.lengths = [lengths[count]]
	part2_prin1_content.sectionNames = ["Article", "Paragraph"]
	part2_prin1_content.heSectionNames = [u"סעיף", u"פרק"]
	part2_prin1_content.addressTypes = ["Integer", "Integer"]
