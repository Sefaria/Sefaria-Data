...
if __name__ == "__main__":
    ...
    posting = True
    individuals = [332]  # range(325, 1479) # 332 range(110, 1479) #[119, 170, 260, 620, 775, 1403, 1404, 1405, 1406, 1407, 1408, 35, 118, 169, 259, 619, 774, 1402, 1403, 1404, 1405, 1406, 1407]
