...
if __name__ == "__main__":
    ...
    leviticus_parshiot = (
        u"Leviticus", ["Vayikra", "Tzav", "Shmini", "Tazria", "Metzora", "Tazria-Metzora", "Achrei Mot",
                       "Kedoshim", "Achrei Mot-Kedoshim", "Emor", "Behar", "Bechukotai",
                       "Behar-Bechukotai"])
    ...
    for which_parshiot in [genesis_parshiot, exodus_parshiot, leviticus_parshiot, numbers_parshiot, devarim_parshiot]:
        ...
        for parsha in which_parshiot[1]:
            ...
            sheets = ["1291.html"]
            found_tables_in_parsha = parser.bs4_reader(["html_sheets/{}/{}".format(parsha, sheet) for sheet in sheets],
                                                       post=posting)  # if sheet in os.listdir("html_sheets/{}".format(parsha)) and sheet != "163.html"], post=posting)
