...
def new_munich_msp(num, refs):
    ...
    msp.image_url = f'https://manuscripts.sefaria.org/munich-manuscript/munich-manuscript-95Cod.hebr.95pg.{num}.jpg'
    msp.thumbnail_url = f'https://manuscripts.sefaria.org/munich-manuscript/munich-manuscript-95Cod.hebr.95pg.{num}_thumbnail.jpg'
