...
title_book = "Mishnah Rosh Hashanah"
title_comm = "Rambam on Mishnah Rosh Hashanah" 
f=open('rosh_hashanah.txt', 'r')
...
log = []
'''
has daf inside parenthesis, @33 start of comment, @11 start of DH, @22 end of DH
		  	...
		  	if mishnah_n > 0:
				...
				if prev_comm != curr_comm:
				  if curr_comm[0] == ' ':
					...
					"language": "he",
					"text": comm_dict[curr_comm]+str_curr_comm,
					}
					prev_comm = curr_comm
