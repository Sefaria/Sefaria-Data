...
title_book = "Mishnah Kiddushin"
title_comm = "Rambam on Mishnah Kiddushin" 
...
def getLog(hyperlink, siman, result):
	...
	for key in result:
		...
		if list[0] == 0:
			...
			log.append("In perek " +str(siman)+", dibbur hamatchil #"+str(count)+"is not matched\n\n")
		elif len(list) > 1:
