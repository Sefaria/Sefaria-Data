...
parshiot = ["Shemot", "Vaera", "Bo", "Beshalach", "Yitro",
...
prev_parsha = ""
last_log = ""
if os.path.exists("alt_yalkut_exodus.txt") == True:
	os.remove("alt_yalkut_exodus.txt")	
info_file = open('alt_yalkut_exodus.txt', 'w')
info_file.write("Shemot,"+str(current_perek)+","+str(current_remez)+","+str(para_n+1)+"\n")
