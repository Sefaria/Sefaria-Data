...
prev_parsha = ""
last_log = ""
if os.path.exists("alt_yalkut_deut.txt") == True:
	os.remove("alt_yalkut_deut.txt")	
info_file = open('alt_yalkut_deut.txt', 'w')
info_file.write("Devarim,"+str(current_perek)+","+str(current_remez)+","+str(para_n+1)+"\n")
