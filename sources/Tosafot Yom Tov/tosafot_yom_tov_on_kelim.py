...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Kelim", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה כלים", "he", primary=True)
root.key = "tosafot_yom_tov_kelim"

sections = [("Kelim", u"כלים", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Kelim",
