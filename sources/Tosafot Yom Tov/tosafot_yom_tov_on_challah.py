...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Challah", "en", primary=True)
root.add_title(u"תוספות יום טוב על חלה", "he", primary=True)
root.key = "tosafot_yom_tov_challah"

sections = [("Challah", u"חלה", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Challah",
