...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Nazir", "en", primary=True)
root.add_title(u"תוספות יום טוב על נזיר", "he", primary=True)
root.key = "tosafot_yom_tov_nazir"

sections = [("Nazir", u"נזיר", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Nazir",
