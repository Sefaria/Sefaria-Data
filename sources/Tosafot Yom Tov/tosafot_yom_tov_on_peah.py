...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Peah", "en", primary=True)
root.add_title(u"תוספות יום טוב על פאה", "he", primary=True)
root.key = "tosafot_yom_tov_peah"

sections = [("Peah", u"פאה", 1)]
