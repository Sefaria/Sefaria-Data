...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Middot", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה מדות", "he", primary=True)
root.key = "tosafot_yom_tov_middot"

sections = [("Middot", u"מדות", 1)]
