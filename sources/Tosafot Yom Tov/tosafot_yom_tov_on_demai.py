...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Demai", "en", primary=True)
root.add_title(u"תוספות יום טוב על דמאי", "he", primary=True)
root.key = "tosafot_yom_tov_demai"

sections = [("Demai", u"דמאי", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Demai",
