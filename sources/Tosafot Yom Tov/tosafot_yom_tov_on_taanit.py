...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Taanit", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה תענית", "he", primary=True)
root.key = "tosafot_yom_tov_taanit"

sections = [("Taanit", u"תענית", 1)]
