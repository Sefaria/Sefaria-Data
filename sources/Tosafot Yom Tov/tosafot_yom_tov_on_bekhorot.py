...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Bekhorot", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה בכורות", "he", primary=True)
root.key = "tosafot_yom_tov_bekhorot"

sections = [("Bekhorot", u"בכורות", 1)]
