...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Avot", "en", primary=True)
root.add_title(u"תוספות יום טוב על אבות", "he", primary=True)
root.key = "tosafot_yom_tov_avot"

sections = [("Avot", u"אבות", 1)] 
