...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Makhshirin", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה מכשירין", "he", primary=True)
root.key = "tosafot_yom_tov_makhshirin"

sections = [("Makhshirin", u"מכשירין", 0)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Makhshirin",
