...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Chagigah", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה חגיגה", "he", primary=True)
root.key = "tosafot_yom_tov_chagigah"

sections = [("Chagigah", u"חגיגה", 1)]
