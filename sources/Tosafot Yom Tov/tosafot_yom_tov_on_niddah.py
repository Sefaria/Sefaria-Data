...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Niddah", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה נדה", "he", primary=True)
root.key = "tosafot_yom_tov_niddah"

sections = [("Niddah", u"נדה", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Niddah",
