...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Makkot", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה מכות", "he", primary=True)
root.key = "tosafot_yom_tov_makkot"

sections = [("Makkot", u"מכות", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Makkot",
