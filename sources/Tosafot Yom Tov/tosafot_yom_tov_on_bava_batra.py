...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Bava Batra", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה בבא בתרא", "he", primary=True)
root.key = "tosafot_yom_tov_bava_batra"

sections = [("Bava Batra", u"בבא בתרא", 1)]
