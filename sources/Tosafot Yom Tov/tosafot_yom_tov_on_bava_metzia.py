...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Bava Metzia", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה בבא מציעא", "he", primary=True)
root.key = "tosafot_yom_tov_bava_metzia"

sections = [("Bava Metzia", u"בבא מציעא", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Bava Metzia",
