...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Moed Katan", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה מועד קתן", "he", primary=True)
root.key = "tosafot_yom_tov_moed"

sections = [("Moed Katan", u"מועד קתן", 1)]
