...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Berakhot", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה ברכות", "he", primary=True)
root.key = "tosafot_yom_tov_mishnah_berakhot"

sections = [("Berakhot", u"ברכות", 0)]
