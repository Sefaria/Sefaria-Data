...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Sotah", "en", primary=True)
root.add_title(u"תוספות יום טוב על סוטה", "he", primary=True)
root.key = "tosafot_yom_tov_sotah"

sections = [("Sotah", u"סוטה", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Sotah",
