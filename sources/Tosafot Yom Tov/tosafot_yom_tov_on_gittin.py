...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Gittin", "en", primary=True)
root.add_title(u"תוספות יום טוב על גיטין", "he", primary=True)
root.key = "tosafot_yom_tov_gittin"

sections = [("Gittin", u"גיטין", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Gittin",
