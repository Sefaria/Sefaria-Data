...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Oholot", "en", primary=True)
root.add_title(u"תוספות יום טוב על אהלות", "he", primary=True)
root.key = "tosafot_yom_tov_oholot"

sections = [("Oholot", u"אהלות", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Oholot",
