...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Eruvin", "en", primary=True)
root.add_title(u"תוספות יום טוב על עירובין", "he", primary=True)
root.key = "tosafot_yom_tov_eruvin"

sections = [("Eruvin", u"עירובין", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Eruvin",
