...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Oktzin", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה עוקצים", "he", primary=True)
root.key = "tosafot_yom_tov_oktzin"

sections = [("Oktzin", u"עוקצים", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Oktzin",
