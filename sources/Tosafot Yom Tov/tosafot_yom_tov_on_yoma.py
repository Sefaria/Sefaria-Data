...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Yoma", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה יומא", "he", primary=True)
root.key = "tosafot_yom_tov_yoma"

sections = [("Yoma", u"יומא", 1)]
