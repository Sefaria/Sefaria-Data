...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Chullin", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה חולין", "he", primary=True)
root.key = "tosafot_yom_tov_chullin"

sections = [("Chullin", u"חולין", 1)]
