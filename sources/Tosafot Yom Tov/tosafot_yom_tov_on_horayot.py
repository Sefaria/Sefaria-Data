...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Horayot", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה הוריות", "he", primary=True)
root.key = "tosafot_yom_tov_horayot"

sections = [("Horayot", u"הוריות", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Horayot",
