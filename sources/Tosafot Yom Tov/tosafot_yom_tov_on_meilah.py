...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Meilah", "en", primary=True)
root.add_title(u"תוספות יום טוב על מעילה", "he", primary=True)
root.key = "tosafot_yom_tov_meilah"

sections = [("Meilah", u"מעילה", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Meilah",
