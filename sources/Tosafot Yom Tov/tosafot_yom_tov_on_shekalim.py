...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Shekalim", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה שקלים", "he", primary=True)
root.key = "tosafot_yom_tov_shekalim"

sections = [("Shekalim", u"שקלים", 1)]
