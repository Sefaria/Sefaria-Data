...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Menachot", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה מנחות", "he", primary=True)
root.key = "tosafot_yom_tov_menachot"

sections = [("Menachot", u"מנחות", 1)]
