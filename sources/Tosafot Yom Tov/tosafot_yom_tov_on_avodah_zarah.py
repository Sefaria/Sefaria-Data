...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Avodah Zarah", "en", primary=True)
root.add_title(u"תוספות יום טוב על עבודה זרה", "he", primary=True)
root.key = "tosafot_yom_tov_avodah"

sections = [("Avodah Zarah", u"עבודה זרה", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Avodah Zarah",
