...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Tamid", "en", primary=True)
root.add_title(u"תוספות יום טוב על תמיד", "he", primary=True)
root.key = "tosafot_yom_tov_tamid"

sections = [("Tamid", u"תמיד", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Tamid",
