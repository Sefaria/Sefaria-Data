...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Orlah", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה ערלה", "he", primary=True)
root.key = "tosafot_yom_tov_orlah"

sections = [("Orlah", u"ערלה", 1)]
