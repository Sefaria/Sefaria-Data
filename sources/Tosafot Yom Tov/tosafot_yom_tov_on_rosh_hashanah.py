...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Rosh Hashanah", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה ראש השנה", "he", primary=True)
root.key = "tosafot_yom_tov_rosh"

sections = [("Rosh Hashanah", u"ראש השנה", 1)]
