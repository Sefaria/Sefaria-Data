...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Yadayim", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה ידים", "he", primary=True)
root.key = "tosafot_yom_tov_yadayim"

sections = [("Yadayim", u"ידים", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Yadayim",
