...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Nedarim", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה נדרים", "he", primary=True)
root.key = "tosafot_yom_tov_nedarim"

sections = [("Nedarim", u"נדרים", 1)]
