...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Megillah", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה מגילה", "he", primary=True)
root.key = "tosafot_yom_tov_megillah"

sections = [("Megillah", u"מגילה", 1)]
