...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Sanhedrin", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה סנהדרין", "he", primary=True)
root.key = "tosafot_yom_tov_sanhedrin"

sections = [("Sanhedrin", u"סנהדרין", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Sanhedrin",
