...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Tevul Yom", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה טבול יום", "he", primary=True)
root.key = "tosafot_yom_tov_tevul_yom"

sections = [("Tevul Yom", u"טבול יום", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Tevul Yom",
