...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Negaim", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה נגעים", "he", primary=True)
root.key = "tosafot_yom_tov_negaim"

sections = [("Negaim", u"נגעים", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Negaim",
