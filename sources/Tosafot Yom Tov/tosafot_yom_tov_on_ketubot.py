...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Ketubot", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה כתובות", "he", primary=True)
root.key = "tosafot_yom_tov_ketubot"

sections = [("Ketubot", u"כתובות", 1)]
