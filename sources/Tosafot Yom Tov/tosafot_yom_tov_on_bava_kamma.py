...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Bava Kamma", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה בבא קמא", "he", primary=True)
root.key = "tosafot_yom_tov_bava_kamma"

sections = [("Bava Kamma", u"בבא קמא", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Bava Kamma",
