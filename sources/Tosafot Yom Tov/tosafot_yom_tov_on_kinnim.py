...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Kinnim", "en", primary=True)
root.add_title(u"תוספות יום טוב על קינים", "he", primary=True)
root.key = "tosafot_yom_tov_kinnim"

sections = [("Kinnim", u"קינים", 1)] 
...
index = {
    "title": "Tosafot Yom Tov on Kinnim",
