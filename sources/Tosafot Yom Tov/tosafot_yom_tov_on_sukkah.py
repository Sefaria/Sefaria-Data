...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Sukkah", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה סוכה", "he", primary=True)
root.key = "tosafot_yom_tov_sukkah"

sections = [("Sukkah", u"סוכה", 1)]
