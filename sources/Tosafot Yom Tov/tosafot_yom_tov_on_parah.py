...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Parah", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה פרה", "he", primary=True)
root.key = "tosafot_yom_tov_mishnah_parah"

sections = [("Parah", u"פרה", 0)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Parah",
