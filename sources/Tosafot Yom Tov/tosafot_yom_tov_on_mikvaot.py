...
root = SchemaNode()
root.add_title("Tosafot Yom Tov on Mishnah Mikvaot", "en", primary=True)
root.add_title(u"תוספות יום טוב על משנה מקואות", "he", primary=True)
root.key = "tosafot_yom_tov_mikvaot"

sections = [("Mikvaot", u"מקואות", 1)]
...
index = {
    "title": "Tosafot Yom Tov on Mishnah Mikvaot",
