...
def download_london_tiles(i, side):
    tiles = [[] for _ in range(25)]
    page = f'{str(i).zfill(3)}{side}'
    rows = 24 if (11 < i < 61 and side == 'r') or (i > 57 and side == 'v') else 25
    columns = 18 if i in [26, 59 ,60] and side == 'r' else 19
    for m in range(rows:
...
if __name__ == '__main__':
    for i in range(3, 74):
        for side in ['v', 'r']:
            ...
            page_image = combine_tiles_2d(tiles, )
