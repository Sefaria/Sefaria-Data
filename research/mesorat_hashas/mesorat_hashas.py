...
#generate_dicta_input("Tanakh")
#dicta_all_to_all('dicta_input_Talmud/', 'dicta_input_Tanakh/', True, 9, False)
#generate_dicta_output(["Talmud"])
#filter_pasuk_matches2("Talmud", ["Tanakh", "Talmud"])
#filter_pasuk_matches('Talmud','mesorat_hashas_indexes_Talmud.json')
#filter_close_matches('mesorat_hashas_pasuk_filtered.json')
#remove_mishnah_talmud_dups('mesorat_hashas_clustered_9_words.json')
save_links_dicta("All", 'mesorat_hashas_mishnah_filtered_All.json')
#compare_mesorat_hashas('mesorat_hashas_mishnah_filtered_All.json', 'mesorat_hashas_mishnah_filtered.json')
