...
def test_source_sheet_disambiguator():
    ids = [1697,2636,8689,11419,13255,16085,18838,26981,27226,31603,31844,35830,49364,50853,57106,65498,85003,90289,92571,101667,105718]
    rows = []
    start_row = 0
    with open("test.csv", "rb") as fin:
        ...
        for i, id in enumerate(ids):
            ...
            rows += new_rows
            for irow in xrange(start_row, start_row + len(new_rows)):
                csv_row = cin.next()
