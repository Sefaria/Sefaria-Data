...
word_list_in,test_set_lens,bib_links = language_tools.get_test_set(text_name,400,strip_html=False,get_bib_links=True)
language_tools.tag_testing_naive(text_name,bib_links,test_set_lens,word_list_in,test_set_name)
...
language_tools.print_tagged_corpus_to_html_table(test_set_name,"naive")
