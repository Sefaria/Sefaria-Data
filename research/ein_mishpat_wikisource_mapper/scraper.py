...
wiki_root = "https://he.wikisource.org"
root_url_list = ["https://he.wikisource.org/wiki/%D7%91%D7%91%D7%9C%D7%99_%D7%A1%D7%A0%D7%94%D7%93%D7%A8%D7%99%D7%9F",
                 "https://he.wikisource.org/wiki/%D7%91%D7%91%D7%9C%D7%99_%D7%92%D7%99%D7%98%D7%99%D7%9F"]
out_obj = {}
            ...
            for desc in all_descendants:
                if complex_child is not None:
                    try:
                        ...
                        complex_child = None
                elif len(direct_children) > curr_dir_child_index and str(desc) == str(direct_children[curr_dir_child_index]):
                    if len(super_scripts) > curr_super_index and str(next(desc.descendants)) == str(super_scripts[curr_super_index]):
                        super_index_list += [len(all_gmara_text)+1]
                        super_text_list += [str(super_scripts[curr_super_index])]
                        curr_super_index += 1
